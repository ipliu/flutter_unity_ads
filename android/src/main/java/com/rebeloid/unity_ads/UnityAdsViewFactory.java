...
final class UnityAdsViewFactory extends PlatformViewFactory {
    ...
    public UnityAdsViewFactory(@NonNull AdInstanceManager manager) {
    ...
    private static PlatformView getErrorView(@NonNull final Context context, int adId) {
        ...
        if (BuildConfig.DEBUG) {
            ...
            Log.e(UnityAdsViewFactory.class.getSimpleName(), message);
